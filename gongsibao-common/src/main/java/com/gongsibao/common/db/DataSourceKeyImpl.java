 ...
 * 数据源key的存储控制器
 */
public class DataSourceKeyImpl implements DataSourceKey, InitializingBean, ApplicationContextAware {
    ...
    public void setReadDateSourceMap(Map<String, String> readDateSourceMap) {
        ...
        dateSourceReadKeys = Collections.synchronizedList(new ArrayList<String>(readDateSourceMap.values()));
    }
